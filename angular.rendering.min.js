...
(function (Q, X, w) {
  ...
  function ka(b, a) {
    ...
    if (c == typeof a && "object" == c)
      if (J(b)) {
        ...
        if (ab(b) || ab(a) || Za(b) || Za(a) || J(a) || ea(a) || Oa(a))
          return !1;
        c = fa();
        for (d in b)
          if ("$" !== d.charAt(0) && !x(b[d])) {
  ...
  function ce() {
    ...
    if (!Bc) {
      var a = pb();
      (ra = v(a) ? Q.jQuery : a ? Q[a] : w) && ra.fn.on
        ? ((B = ra),
          P(ra.fn, {
            scope: Ra.scope,
  ...
  function rb(b) {
    for (
      var a = b[0], c = b[b.length - 1], d, e = 1;
      a !== c && (a = a.nextSibling);
      e++
    )
  ...
  function wb(b, a) {
    ...
    a &&
      !c &&
      ((b.ng339 = c = ++Ff), (c = hb[c] = { events: {}, data: {}, handle: w }));
    return c;
  }
  function Vb(b, a, c) {
    if (Lc(b)) {
                  ...
                  try {
                    ...
                    C(l.scope) &&
                      (!0 === l.bindToController
                        ? ((n.bindToController = c(l.scope, r, !0)),
                          (n.isolateScope = {}))
      ...
      function (a, b, c, d, u, q, z, N, ia, O, H) {
        ...
        function W(a, b, c, d, e) {
          ...
          return function (b, c, d) {
            ...
            g ||
              (g = (d = d && d[0])
                ? "foreignobject" !== wa(d) && d.toString().match(/SVG/)
                  ? "svg"
                  : "html"
                : "html");
            d =
              "html" !== g
                ? B(Xb(g, B("<div>").append(a).html()))
                : c
                ? Ra.clone.call(a)
                : a;
            if (h)
        ...
        function S(a, b, c, d, e, f) {
          function g(a, c, d, e) {
            var f, k, l, r, n, t, O;
            if (q)
              for (O = Array(c.length), r = 0; r < h.length; r += 3)
                (f = h[r]), (O[f] = c[f]);
            else O = c;
            r = 0;
            for (n = h.length; r < n; )
          ...
          for (var h = [], k, l, r, n, q, t = 0; t < a.length; t++) {
            ...
            (f = l.length ? D(l, a[t], k, b, c, null, [], [], f) : null) &&
              f.scope &&
        ...
        function ca(a, b, c, d, e) {
          ...
          switch (a.nodeType) {
            case pa:
              na(b, ya(wa(a)), "E", d, e);
              for (
                var l, r, n, q = a.attributes, t = 0, O = q && q.length;
                t < O;
                t++
              ) {
                var K = !1,
            ...
            if (ca) {
              ...
              Va &&
                ...
                (H = ca[Va.name]) &&
                  ...
                  q &&
                  ((m = H),
                  (l.$$destroyBindings = Y(c, f, H.instance, q, Va))));
              for (n in ca) {
                H = ca[n];
                var D = H();
                D !== H.instance &&
                  ...
                  H === m &&
                    (l.$$destroyBindings(),
                    (l.$$destroyBindings = Y(c, f, D, q, Va))));
              }
            }
            n = 0;
        ...
        function Mf(a, b, c, e, f, g, h, k) {
          ...
          return function (a, b, c, d, e) {
            ...
            b.$$destroyed ||
              (l
                ? l.push(b, c, d, a)
                : (r.transcludeOnThisElement && (a = ba(b, r.transclude, e)),
                  r(n, b, c, d, a, r)));
          };
        }
        function M(a, b) {
        ...
        function U(a, b, c) {
          ...
          B.hasData(d) &&
            (B(c).data(B(d).data()),
            ra ? ((Qb = !0), ra.cleanData([d])) : delete B.cache[d[B.expando]]);
          d = 1;
            ...
            switch (e.mode) {
              ...
              case "=":
                ...
                l = e.collection
                  ...
                  : a.$watch(u(c[k], l), null, n.literal);
                h = h || [];
                h.push(l);
                break;
              case "&":
      ...
      function (e, f, h, g, l, k) {
        function n(a) {
          function d(a) {
            var b = P({}, a);
            b.data = a.data
              ? dd(a.data, a.headers, a.status, f.transformResponse)
              : a.data;
            a = a.status;
          ...
          f.paramSerializer = G(f.paramSerializer)
        ...
        var t = h("$http");
        b.paramSerializer = G(b.paramSerializer)
  ...
  function Sf(b, a, c, d, e) {
    ...
    return function (e, g, l, k, n, p, r, t) {
      ...
      if ("jsonp" == F(e)) {
        ...
        var q = f(
          g.replace("JSON_CALLBACK", "angular.callbacks." + u),
          u,
          function (a, b) {
            K(k, a, d[u].data, "", b);
            d[u] = y;
    ...
    this.$get = [
      ...
      function (c, d, e) {
        ...
        function g(f, g, n, p) {
          ...
          p = !!p;
          for (
            var q, m, N = 0, s = [], O = [], H = f.length, L = [], W = [];
            N < H;
      ...
      function (b, a, c, d) {
        function e(e, g, l, k) {
          ...
          q.$$intervalId = r(function () {
            ...
            0 < l &&
              E >= l &&
              (u.resolve(E), t(q.$$intervalId), delete f[q.$$intervalId]);
            K || b.$apply();
          }, g);
          f[q.$$intervalId] = u;
          return q;
        ...
        f.on("click", function (b) {
          if (
            ...
            E.test(g) ||
              ...
              (b.preventDefault(),
              k.absUrl() != d.url() &&
                (c.$apply(), (h.angular["ff-684208-preventDefault"] = !0)));
          }
        });
            ...
            (K = !1),
              c.$evalAsync(function () {
                ...
                k.absUrl() === b &&
                  (d
                    ? (k.$$parse(a), (k.$$state = f))
                    : (r && g(b, h, f === k.$$state ? null : k.$$state),
                      l(a, f)));
              });
          k.$$replace = !1;
        });
    ...
    this.$get = [
      ...
      function (c) {
        ...
        function e(a, b, c, e, f) {
          ...
          for (var l = [], n = [], p = 0, m = g.length; p < m; p++)
            (l[p] = d), (n[p] = null);
          return a.$watch(
            function (a) {
  ...
  function qf() {
    this.$get = [
      ...
      function (b, a) {
        var c = {},
          d = Y(
            (/android (\d+)/.exec(F((b.navigator || {}).userAgent)) || [])[1]
          ),
        ...
        if (l) {
          ...
          !d ||
            (k && n) ||
            ((k = G(l.webkitTransition)), (n = G(l.webkitAnimation)));
        }
        return {
  ...
  function zd(b) {
    ...
    return function (b, d, e) {
      ...
      return null == b
        ? b
        : Dd(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, e).replace(
            /\u00A4/g,
            d
          );
    };
  ...
  function Bd(b) {
    ...
    return function (b, d) {
      return null == b
        ? b
        : Dd(b, a.PATTERNS[0], a.GROUP_SEP, a.DECIMAL_SEP, d);
    };
  }
  function Dd(b, a, c, d, e) {
    ...
    if (h || k)
      0 < e &&
        1 > b &&
        ((l = b.toFixed(e)), (b = parseFloat(l)), (l = l.replace(hc, d)));
    else {
      ...
      var h = ("" + b).split(hc),
        ...
        t = a.gSize;
      if (g.length >= r + t)
        for (p = g.length - r, k = 0; k < p; k++)
          0 === (p - k) % t && 0 !== k && (l += c), (l += g.charAt(k));
      for (k = p; k < g.length; k++)
        0 === (g.length - k) % r && 0 !== k && (l += c), (l += g.charAt(k));
      for (; h.length < e; ) h += "0";
            ...
            "ngClass" !== b &&
              f.$watch("$index", function (c, d) {
                ...
                if (h !== (d & 1)) {
                  var k = e(f.$eval(g[b]));
                  h === a
                    ? ((h = l(k, 1)), g.$addClass(h))
                    : ((h = l(k, -1)), g.$removeClass(h));
                }
              });
          },
        };
  ...
  function Hd(b) {
    ...
    d.$setValidity = function (b, e, f) {
      v(e)
        ...
        : (d.$pending && g(d.$pending, b, f),
          Ld(d.$pending) && (d.$pending = w));
      bb(e)
        ? e
  ...
  var J = Array.isArray,
    ...
    pb = function () {
      ...
      for (a = 0; a < c; ++a)
        if (
          ((d = Qa[a]),
          (b = X.querySelector("[" + d.replace(":", "\\:") + "jq]")))
        ) {
  ...
  var Ra = (R.prototype = {
      ready: function (b) {
        ...
        "complete" === X.readyState
          ? setTimeout(a)
          : (this.on("DOMContentLoaded", a), R(Q).on("load", a));
      },
      toString: function () {
        var b = [];
        m(this, function (a) {
  ...
  m(
    {
      ...
      scope: function (b) {
        return (
          B.data(b, "$scope") ||
          Ab(b.parentNode || b, ["$isolateScope", "$scope"])
        );
      },
        ...
        if (d !== Pa && 2 !== d && 8 !== d)
          if (((d = F(a)), Bb[d]))
            if (A(c))
              ...
              return b[a] || (b.attributes.getNamedItem(a) || y).specified
                ? d
                : w;
  ...
  m(
    {
      ...
      on: function a(c, d, e, f) {
        ...
        if (Lc(c)) {
          ...
          g || (g = h.handle = Hf(c, f));
          for (
            var h = 0 <= d.indexOf(" ") ? d.split(" ") : [d], l = h.length;
            l--;
  ...
  fb.$$annotate = function (a, c, d) {
    ...
    if ("function" === typeof a) {
      if (!(e = a.$inject)) {
        ...
        if (a.length) {
          if (c)
            throw ((G(d) && d) || (d = a.name || If(a)), Ha("strictdi", d));
                    ...
                    if (a.computed)
                      (l = k.nextId()),
                        ...
                        f &&
                          1 !== f &&
                          k.if_(
                            k.not(k.computedMember(g, l)),
                            k.lazyAssign(k.computedMember(g, l), "{}")
                          ),
      ...
      switch (a.type) {
        ...
        case s.MemberExpression:
          return (
            ...
            a.computed ||
              (Xa(a.property.name, h.expression), (f = a.property.name)),
              ...
              : function (a, d, e, p) {
                  ...
                  if (null != r.value) {
                    ...
                    for (var s = 0; s < g.length; ++s)
                      m.push(Ba(g[s](a, d, e, p), h.expression));
        ...
        if (!c.href && !c.xlinkHref)
          return function (a, c) {
            if ("a" === c[0].nodeName.toLowerCase()) {
              var f =
                "[object SVGAnimatedString]" === va.call(c.prop("href"))
                  ? "xlink:href"
                  : "href";
                ...
                pre: function (a, d, f, h) {
                  ...
                  g &&
                    ...
                    f.$observe(g, function (c) {
                      m.$name !== c &&
                        (s(a, w),
                        m.$$parentForm.$$renameControl(m, c),
                        (s = e(m.$name)),
                        s(a, m));
                    }));
                  d.on("$destroy", function () {
    ...
    xg = [
      ...
      function (a, c, d, e, f, h, g, l, k, n) {
        ...
        this.$$parseAndValidate = function () {
          ...
          f &&
            ((q.$modelValue = c),
            q.$modelValue !== e && q.$$writeModelToScope());
        ...
        a.$watch(function () {
          ...
          if (
            c !== q.$modelValue &&
            (q.$modelValue === q.$modelValue || c === c)
          ) {
            q.$modelValue = q.$$rawModelValue = c;
            u = w;
            for (var d = q.$formatters, e = d.length, f = c; e--; ) f = d[e](f);
            q.$viewValue !== f &&
              ((q.$viewValue = q.$$lastCommittedViewValue = f),
              q.$render(),
              q.$$runValidators(c, f, y));
          }
          return c;
        });
      },
            ...
            return {
              ...
              post: function (c, e, f, h) {
                ...
                e.on("blur", function (e) {
                  g.$touched ||
                    (a.$$phase
                      ? c.$evalAsync(g.$setTouched)
                      : c.$apply(g.$setTouched));
                });
              },
            };
          },
        ...
        return {
          ...
          link: function (c, g, l, k) {
            ...
            function v() {
              ...
              if (!w.$isEmpty(a)) {
                var h = u.readValue();
                (C.trackBy ? ka(a, h) : a === h) ||
                  (w.$setViewValue(h), w.$render());
              }
            }
            var w = k[1];
            if (w) {
                ...
                ? ((w.$isEmpty = function (a) {
                  ...
                  (u.readValue = function () {
                    var a = g.val() || [],
                      c = [];
                    m(a, function (a) {
                      (a = x.selectValueMap[a]) &&
                        !a.disabled &&
                        c.push(x.getViewValueFromOption(a));
                    });
                    return c;
                  }),
                  C.trackBy &&
              ...
              O
                ? (q.remove(), a(q)(c), q.removeClass("ng-scope"))
                : (q = B(e.cloneNode(!1)));
              v();
            ...
            h.$watch(n, function (c) {
              ...
              e === x ||
                ...
                v(f)
                  ? (null != c &&
                      d.debug(
                        "ngPluralize: no rule defined for '" + e + "' in " + p
                      ),
                    (z = y),
                    k())
                  : (z = h.$watch(f, k)),
            ...
            return function (a, f, h, k, n) {
              ...
              a.$watchCollection(p, function (h) {
                ...
                if (Da(h)) (I = h), (p = q || z);
                  ...
                  for (L in ((p = q || A), (I = []), h))
                    ta.call(h, L) && "$" !== L.charAt(0) && I.push(L);
                C = I.length;
                L = Array(C);
                for (k = 0; k < C; k++)
                  if (
                ...
                for (k = 0; k < C; k++)
                  if (
                    ((G = h === I ? k : I[k]), (J = h[G]), (F = L[k]), F.scope)
                  ) {
                    u = t;
                    do u = u.nextSibling;
...
app.filter("hexValue", function () {
  return function (hexString) {
    ...
    else hexString = hexString.replace(/[^0-9a-fA-F#]/gi, "");
    return hexString;
  };
});
/**
  ...
  return function (industries, industrySearchKeyword) {
    ...
    if (!industrySearchKeyword) {
      ...
      for (var i = 0; i < industries.length; i++) {
        if (
          industries[i].name.toLowerCase().indexOf(searchKeyword) > -1 ||
...
app.config(function (
  ...
  $compileProvider.aHrefSanitizationWhitelist(
    /^\s*(https?|ftp|tel|mailto|file|skype|weixin|fb):/
  );
...
app.loadBasePreviewController = function () {
  return app.controller(
    "BasePreviewController",
    function ($rootScope, $scope, previewService) {
        ...
        _.delay(function () {
          ...
          $.each(
            ...
            function (key, element) {
              ...
              $errorMessage = $(
                ".errorHolder",
                $(element).parents(".formly-field")
              );

              //check if there is already a popup on the error holder
              if (
                $($errorMessage.attr("data-error-container")).hasAttr(
                  "aria-describedby"
                )
              ) {
                ...
                var tooltipID =
                  "#" +
                  $($errorMessage.attr("data-error-container")).attr(
                    "aria-describedby"
                  );
                //fade out
...
app.factory("previewService", function ($rootScope) {
  ...
  previewModel.updateForm = function () {
    $("#formHere input[id$='_json_data']").val(
      JSON.stringify(this.previewModel)
    );
    try {
...
app.controller("MobilePreviewController", function ($scope) {
  ...
  $scope.codeValidation = function () {
    ...
    if (
      $(".angularWrapper .ng-invalid").length ||
      $(".angularWrapper .box-input.error").length
    ) {
      $.each(
        $(".angularWrapper .canHaveError.ng-invalid"),
        function (key, element) {
          // Add error handling
          $(element).parent().addClass("error");
          errorMessage = $(".errorHolder", $(element).parents(".formly-field"));
          window.qr.utils.formValidationTooltip(
            errorMessage.attr("data-error-container"),
            errorMessage.attr("data-error-msg"),
            true,
            true
          );
        }
...
var SocialShareKit = (function () {
  var s = /(twitter|facebook|google-plus|pinterest|tumblr|vk|linkedin|email)/,
    o = "*|*",
    j,
    b;
  b = function (z) {
    ...
    share: function () {
      ...
      l(function () {
        ...
        e(z, function (D) {
          ...
          p(D, "click", A);
          n(D, "click", A);
          if (D.parentNode.className.indexOf("ssk-count") !== -1) {
            E = E[0];
            C = E + o + w(y, E, D);
            if (!(C in x)) {
              x[C] = [];
      ...
      function A(I) {
        ...
        if (
          window.twttr &&
          H.getAttribute("href").indexOf("twitter.com/intent/") !== -1
        ) {
  ...
  function p(z, x, y) {
    if (z.removeEventListener) {
      z.removeEventListener(x, y);
    } else {
      z.detachEvent("on" + x, y);
    }
  }
  function q(x) {
    return x.className.match(s);
  }
  function i(y) {
    ...
    return x.currentTarget || x.srcElement;
  }
  function h(y) {
    var z = 575,
      x = 400,
      D = document.documentElement.clientWidth / 2 - z / 2,
      C = (document.documentElement.clientHeight - x) / 2,
      A =
  ...
  function r(H, A, z) {
    var x,
      y = a(H, A, z),
      C = w(H, A, z, y),
      E = typeof y.title !== "undefined" ? y.title : k(A),
      G = typeof y.text !== "undefined" ? y.text : d(A),
      B = y.image ? y.image : v("og:image"),
      F = typeof y.via !== "undefined" ? y.via : v("twitter:site"),
      D = {
        shareUrl: C,
        title: E,
        text: G,
    ...
    switch (A) {
      case "facebook":
        x = "https://www.facebook.com/share.php?u=" + D.shareUrlEncoded();
        break;
      case "twitter":
        x =
          ...
          D.shareUrlEncoded() +
          "&text=" +
          encodeURIComponent(E + (G && E ? " - " : "") + G);
        if (F) {
          x += "&via=" + F.replace("@", "");
        }
        break;
      case "google-plus":
        x = "https://plus.google.com/share?url=" + D.shareUrlEncoded();
        break;
      case "pinterest":
        x =
      ...
      case "linkedin":
        ...
        break;
      case "vk":
        x = "https://vkontakte.ru/share.php?url=" + D.shareUrlEncoded();
        break;
      case "email":
        x =
          "mailto:?subject=" +
    ...
    D.networkUrl = x;
    if (H.onBeforeOpen) {
      H.onBeforeOpen(z, A, D);
    }
    return D.networkUrl;
  }
  function w(y, A, z, x) {
    x = x || a(y, A, z);
    return x.url || window.location.href;
  }
  function k(x) {
    var y;
    if (x == "twitter") {
    ...
    return y || document.title;
  }
  function d(x) {
    var y;
    if (x == "twitter") {
      y = v("twitter:description");
    }
    return y || v("description");
  }
  function v(z, y) {
    var A,
      x = f(
        "meta[" +
          (y ? y : z.indexOf("og:") === 0 ? "property" : "name") +
          '="' +
          z +
          '"]'
      );
    if (x.length) {
      A = x[0].getAttribute("content") || "";
    }
    return A || "";
  }
  function a(G, A, z) {
    var y = ["url", "title", "text", "image"],
      x = {},
      E,
      F,
      B,
    ...
    for (C in y) {
      ...
      E =
        z.getAttribute(B) ||
        D.getAttribute(B) ||
        (G[A] && typeof G[A][F] != "undefined" ? G[A][F] : G[F]);
  ...
  function t(C, D, A, E) {
    ...
    switch (C) {
      case "facebook":
        z = "https://graph.facebook.com/?id=" + B;
        y = function (F) {
          return E(F.shares ? F.shares : 0);
        };
        break;
      case "twitter":
        if (A && A.twitter && A.twitter.countCallback) {
          A.twitter.countCallback(D, E);
        }
        break;
      case "google-plus":
        z =
        ...
        y = function (F) {
          F = JSON.parse(F);
          if (F.length) {
            return E(F[0].result.metadata.globalCounts.count);
          }
        };
        m(z, y, x);
        return;
      case "linkedin":
        z = "https://www.linkedin.com/countserv/count/share?url=" + B;
        y = function (F) {
          return E(F.count);
        };
        break;
      case "pinterest":
        z = "https://api.pinterest.com/v1/urls/count.json?url=" + B;
        y = function (F) {
          return E(F.count);
        };
        break;
      case "vk":
        z = "https://vk.com/share.php?act=count&url=" + B;
        y = function (F) {
          return E(F);
        };
        break;
  ...
  function c(z, y, B) {
    var A = "cb_" + z + "_" + Math.round(100000 * Math.random()),
    ...
    if (z == "vk") {
      ...
      if (z == "google-plus") {
        window.services = { gplus: { cb: window[A] } };
      }
    }
    x.src = y + (y.indexOf("?") >= 0 ? "&" : "?") + "callback=" + A;
